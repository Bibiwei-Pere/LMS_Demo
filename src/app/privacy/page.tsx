...
const Privacy = () => {
  return (
    <ContainerDashboard className='container mx-auto p-6'>
      <h2 className='text-4xl text-blue-700 font-bold mb-4'>Privacy Policy</h2>
      <p className='mb-4'>
        At <strong>Lassod Learning</strong>, we value your privacy and are committed to protecting your personal
      ...
      <p className='mb-4'>
        We may collect personal information such as your name, email address, and details related to your learning
        activities when you sign up for Lassod Learning or use our services. We also collect non-personal information,
        such as browser type, operating system, and IP address.
      </p>
      ...
      <p className='mb-4'>
        ...
        communicate with you, support your educational journey, and enhance the user experience. We will not share your
      ...
      <p className='mb-4'>
        Lassod Learning uses cookies to enhance your experience on our platform. Cookies are small text files stored on
      ...
      <p className='mb-4'>
        Lassod Learning may integrate with third-party services such as payment processors. These services have their
